...
import com.portfolio.security.model.Response;
import com.portfolio.security.service.AuthService;
import com.portfolio.security.service.CookieUtil;
import com.portfolio.security.service.JwtUtil;
...
public class MemberController {
    ...
    public Response verify(@RequestBody RequestVerifyEmail requestVerifyEmail, HttpServletRequest req, HttpServletResponse res) {
        Response response;
        try {
            Member member = authService.findByUsername(requestVerifyEmail.getName());
